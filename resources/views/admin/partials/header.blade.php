                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                    <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <span class="d-flex align-items-center">
                            ...
                            @endphp
                            <img class="rounded-circle header-profile-user" src="{{ asset('images/users/' . $avatar) }}" alt="{{Auth::user()->fullname}} Avatar">
                            <span class="text-start ms-xl-2">
                                <span class="d-none d-xl-inline-block ms-1 fw-medium user-name-text">{{Auth::user()->fullname}}</span>
                                <span class="d-none d-xl-block ms-1 fs-12 user-name-sub-text"><td>{{ Auth::user()->level == 1 ? 'Admin' : (Auth::user()->level == 2 ? 'Staff' : 'User') }}</span>
                            </span>
                        </span>
                    </button>
