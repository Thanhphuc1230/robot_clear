                                            ...
                                            @if (count($list) > 0)
                                                @foreach ($list as $item)
                                                    <tr>
                                                        ...
                                                        @php
                                                            $avatar = $item->avatar ? $item->avatar : 'default.jpg';
                                                        @endphp
                                                        <td><img src="{{ asset('images/users/' . $avatar) }}" alt=""
                                                                height="50px"></td>
                                                        <td>{{ $item->fullname }}</td>

                                                        <td>{{ $item->level == 1 ? 'Admin' : ($item->level == 2 ? 'Staff' : 'User') }}
                                                        </td>
                                                        <td class="status">
                                                            @if ($item->status == 1)
