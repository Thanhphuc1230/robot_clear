                            ...
                            <div class="live-preview">
                                <form action="{{ route('admin.'.$nameClass.($action == 'create' ? '.store' : '.update'), ['uuid' => $page->uuid ?? '']) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select mb-3" aria-label="Default select example"
                                                    ...
                                                    @foreach ($page_content as $item)
                                                        <option value="{{ $item->id_page }}"
                                                            {{ (old('parent_id') ?: $page->parent_id ?? '') == $item->id_page ? 'selected' : '' }}>
                                                            {{ $item->name_vn }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                <label for="phonenumberInput" class="form-label">Nội dung (Tiếng việt)</label>
                                        ...
                                        <div class="col-md-6" >
                                            <div class="mb-3" style="display:flex;flex-direction: column;">
                                                <label for="firstNameinput" class="form-label">Background hiện tại</label>
                                                <img src="{{asset('images/pages/' .$page->avatar)}}" alt="" width="200px" height="auto">
                                            </div>
                                        </div>
                                        @endif
                                        <!--end col-->
