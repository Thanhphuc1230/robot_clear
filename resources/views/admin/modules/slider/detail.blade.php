                            ...
                            <div class="live-preview">
                                <form action="{{ route('admin.'.$nameClass.($action == 'create' ? '.store' : '.update'), ['uuid' => $page->uuid ?? '']) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label for="firstNameinput" class="form-label">Đường dẫn chuyển trang </label>
                                        ...
                                        {{-- <div class="col-lg-12">
                                            <div class="mb-3">
                                                <label class="form-label" for="meta-keywords-input">Nội dung</label>
                                                <textarea class="form-control" id="my-editor" name="content" rows="3" placeholder="Enter your message">{{ old('content', $page->content ?? '') }}</textarea>
                                            </div>
                                        </div> --}}
                                        ...
                                        <div class="col-md-6" >
                                            <div class="mb-3" style="display:flex;flex-direction: column;">
                                                ...
                                                <img src="{{asset('images/slider/' .$page->avatar)}}" alt="" width="200px" height="auto">
                                            </div>
                                        </div>
                                        @endif
                                        <!--end col-->
