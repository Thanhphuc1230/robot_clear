                            ...
                            <div class="listjs-table" id="customerList">
                                <div class="row g-4 mb-3">
                                    <div class="col-sm-auto">
                                        <div>
                                            <a type="button" href="{{route('admin.'. $nameClass .'.create')}}" class="btn btn-success add-btn"
                                                ><i
                                    ...
                                    <table class="table align-middle table-nowrap" id="customerTable">
                                        ...
                                        <tbody class="list form-check-all">
                                            ...
                                            <tr>
                                                ...
                                                <td><img src="{{asset('images/ads/'.$item->avatar)}}" alt="" width="200px" height="100px" style="object-fit: contain"></td>
                                                <td>{{ $item->name_vn}}</td>
                                                <td class="status">
                                                    @if($item->status == 1)
