                        ...
                        <nav aria-label="breadcrumb">
                            <ul class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a
                                        href="{{ route('website.categoryProduct', ['name_cate_product' => $detail->cate->slug]) }}">{{ $detail->cate->name_vn }}</a>
                                </li>
                                <li class="breadcrumb-item active" aria-current="page">{{ $detail->name_vn }}</li>
                            </ul>
                        </nav>
                    </div>
                </div>
                            ...
                            <div class="col-lg-5">
                                <div class="product-large-slider">
                                    <div class="pro-large-img img-zoom">
                                        <img src="{{ asset('images/products/' . $detail->avatar) }}"
                                            alt="product-details" />
                                    </div>
                                    @php
                                        $imageDetail = json_decode($detail->image_detail);
                                    @endphp
                                    @if ($imageDetail)
                                        @foreach ($imageDetail as $image)
                                            <div class="pro-large-img img-zoom">
                                                <img src="{{ asset('images/products/' . $image) }}" alt="product-details" />
                                            </div>
                                        @endforeach
                                    @endif
                                </div>
                            ...
                            <div class="col-lg-7">
                                <div class="product-details-des">
                                    <div class="manufacturer-name">
                                        <a href="product-details.html">{{ $detail->cate->name_vn }}</a>
                                    </div>
                                    <h3 class="product-name">{{ $detail->name_vn }}</h3>
                                    ...
                                    <div class="price-box">
                                        @if ($detail->discount != 0)
                                            ...
                                            <span class="price-regular">{{ number_format($discountedPrice) }}
                                                VND</span>
                                            <span
                                                class="price-old"><del>{{ number_format($detail->price) }}VND</del></span>
                                        @else
                                            <span class="price-regular">{{ number_format($detail->price) }}
                                                VND</span>
                                        @endif
                                    </div>
                                    <p class="pro-desc">{!! $detail->intro_vn !!}</p>
                                    <form action="{{ route('website.addToCart', ['uuid' => $detail->uuid]) }}"
