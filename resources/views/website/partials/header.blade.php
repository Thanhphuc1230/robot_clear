        ...
        <div class="header-main-area sticky">
            <div class="container">
                <div class="row align-items-center position-relative">
                    ...
                    <div class="col-lg-2">
                        <div class="logo">
                            <a href="{{ route('website.home') }}"><img src="{{ asset('images/logo/' . $website->logo) }}" alt="{{ $website->meta_name }}"></a>
                        </div>
                    </div>
                    <!-- start logo area -->
                                ...
                                <nav class="desktop-menu">
                                    <ul>
                                        @foreach ($menus as $item)
                                            <li class="{{ isActiveMenu($item) }}">
                                                <a href="{{ getUrl($item) }}">
                                                    {{ session('locale') == 'en' ? $item->name_en : $item->name_vn }}
                                                    {!! $item->children->isNotEmpty() ? '<i class="fa fa-angle-down"></i>' : '' !!}
                                                </a>
                                                @if ($item->children->isNotEmpty())
                                                    <ul class="dropdown">
                                                        @foreach ($item->children as $child)
                                                            <li class="{{ isActiveMenu($child) }}">
                                                                <a href="{{ getUrl($child) }}">{{ $child->name_vn }}</a>
                                                            </li>
                                                        @endforeach
                                                    </ul>
                                                @endif
                ...
                <div class="col-12">
                    <div class="mobile-main-header">
                        <div class="mobile-logo">
                            <a href="index.html">
                                <img src="{{ asset('website_style/img/logo/logo.png') }}" alt="Brand Logo">
                            </a>
                        </div>
